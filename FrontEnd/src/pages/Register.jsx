            ...
            {password.length > 0 && (
              <div className="mt-2">
                ...
                <div className="space-y-1">
                  <div className={`text-xs flex items-center gap-1.5 ${hasMinLength ? 'text-green-400' : 'text-white/40'}`}>
                    <div className={`w-1 h-1 rounded-full ${hasMinLength ? 'bg-green-400' : 'bg-white/20'}`} />
                    At least 8 characters
                  </div>
                  <div className={`text-xs flex items-center gap-1.5 ${hasUpperCase ? 'text-green-400' : 'text-white/40'}`}>
                    <div className={`w-1 h-1 rounded-full ${hasUpperCase ? 'bg-green-400' : 'bg-white/20'}`} />
                    One uppercase letter
                  </div>
                  <div className={`text-xs flex items-center gap-1.5 ${hasLowerCase ? 'text-green-400' : 'text-white/40'}`}>
                    <div className={`w-1 h-1 rounded-full ${hasLowerCase ? 'bg-green-400' : 'bg-white/20'}`} />
                    One lowercase letter
                  </div>
                  <div className={`text-xs flex items-center gap-1.5 ${hasNumber ? 'text-green-400' : 'text-white/40'}`}>
                    <div className={`w-1 h-1 rounded-full ${hasNumber ? 'bg-green-400' : 'bg-white/20'}`} />
                    One number
                  </div>
                  <div className={`text-xs flex items-center gap-1.5 ${hasSpecialChar ? 'text-green-400' : 'text-white/40'}`}>
